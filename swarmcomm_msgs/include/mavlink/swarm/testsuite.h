...
static void mavlink_test_node_detected(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_node_detected_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_node_detected_pack(system_id, component_id, &msg , packet1.lps_time , packet1.id , packet1.target_id , packet1.rel_x , packet1.rel_y , packet1.rel_z , packet1.rel_yaw , packet1.cov_x , packet1.cov_y , packet1.cov_z , packet1.cov_yaw );
    mavlink_msg_node_detected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_node_detected_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lps_time , packet1.id , packet1.target_id , packet1.rel_x , packet1.rel_y , packet1.rel_z , packet1.rel_yaw , packet1.cov_x , packet1.cov_y , packet1.cov_z , packet1.cov_yaw );
    mavlink_msg_node_detected_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_node_detected_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_node_detected_send(MAVLINK_COMM_1 , packet1.lps_time , packet1.id , packet1.target_id , packet1.rel_x , packet1.rel_y , packet1.rel_z , packet1.rel_yaw , packet1.cov_x , packet1.cov_y , packet1.cov_z , packet1.cov_yaw );
    mavlink_msg_node_detected_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
