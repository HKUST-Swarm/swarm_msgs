...
#ifndef __DistributedPGOData_t_hpp__
#define __DistributedPGOData_t_hpp__
...
int DistributedPGOData_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int DistributedPGOData_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int DistributedPGOData_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t DistributedPGOData_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* DistributedPGOData_t::getTypeName()
{
    return "DistributedPGOData_t";
}

int DistributedPGOData_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->target_id, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    if(this->frame_num > 0) {
        tlen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &this->frame_ids[0], this->frame_num);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int DistributedPGOData_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->target_id, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    if(this->frame_num) {
        this->frame_ids.resize(this->frame_num);
        tlen = __int64_t_decode_array(buf, offset + pos, maxlen - pos, &this->frame_ids[0], this->frame_num);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int DistributedPGOData_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t DistributedPGOData_t::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == DistributedPGOData_t::getHash)
            return 0;
