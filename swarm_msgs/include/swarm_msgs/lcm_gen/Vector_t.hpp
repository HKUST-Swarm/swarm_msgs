...
int Vector_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int Vector_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int Vector_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t Vector_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* Vector_t::getTypeName()
{
    return "Vector_t";
}

int Vector_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int Vector_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int Vector_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
