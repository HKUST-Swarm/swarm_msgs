...
#ifndef __LoopEdge_t_hpp__
#define __LoopEdge_t_hpp__
...
int LoopEdge_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int LoopEdge_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int LoopEdge_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t LoopEdge_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* LoopEdge_t::getTypeName()
{
    return "LoopEdge_t";
}

int LoopEdge_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int LoopEdge_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int LoopEdge_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t LoopEdge_t::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == LoopEdge_t::getHash)
            return 0;
